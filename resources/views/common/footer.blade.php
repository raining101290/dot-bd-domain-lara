                ...
                <div class="footer-py-60 footer-border">
                    <div class="row">
                        <div class="col-lg-4 col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                            <a href="#" class="logo-footer handlee text-success">
                               <i data-feather="globe" class="fea icon-sm mb-1"></i>  DomainDesk
                            </a>
                        ...
                        <div class="col-lg-3 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <p><i data-feather="phone" class="fea icon-sm mb-1"></i> +88 01883 855555</p>
                                    <p><i data-feather="phone" class="fea icon-sm mb-1"></i> +88 01619 474927</p>
                                </div>
                            </div>
                        </div>
                    </div>
