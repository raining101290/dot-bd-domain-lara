            ...
            <div class="row mt-5 justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="pages-heading">
                        <h4 class="title mt-4 text-white"> Create your account </h4>
                    </div>
                </div> 
            </div>
        </div> 
                            ...
                            <form method="POST" id="form-register">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-20">
                                        ...
                                        <div class="mb-3">
                                            <label for="cpassword" class="form-label text-muted">Confirm Password <span class="text-danger">*</span></label>
                                            <div class="position-relative">
                                ...
                                <div class="form-check-inline">
                                    <div class="mb-0">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="flexCheckDefault1">I have read and agree to the <a href="">Terms of Service</a>, <a href="">Refund Policy</a> and <a href="">Privacy Policy</a></label>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        $("#form-register").on("submit", function (e) {
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    $(".btn-primary").text("Registering...").prop("disabled", true);
                },
                ...
                complete: function () {
                    $(".btn-primary").text("Register").prop("disabled", false);
                }
            });
